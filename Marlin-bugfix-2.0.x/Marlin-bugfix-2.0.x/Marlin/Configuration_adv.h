 ...
 * 
 * Uncommented by Dustin to enable Dual Z Aligning
 */
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below) Changed from 12v to 24v by Dustin
   ...
   */
  #define MONITOR_DRIVER_STATUS       //Uncommented by Dustin
